...
- Diff renderer dependency changes require `src/features/collab/detail/AGENTS.md`. Use CI's affected-path rules for additional macOS/Windows Collab and Pi launch checks rather than assuming Linux tests suffice.
