...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 4,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v4/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 8,
    },
    oldAuthority: {
      bindingVersion: 4,
      gitRemoteUrl: 'https://old.example.test/root/v4/projects/project-cloud/repository.git',
