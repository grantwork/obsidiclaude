...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 6,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v6/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 10,
    },
    oldAuthority: {
      bindingVersion: 6,
      gitRemoteUrl: 'https://old.example.test/root/v6/projects/project-cloud/repository.git',
