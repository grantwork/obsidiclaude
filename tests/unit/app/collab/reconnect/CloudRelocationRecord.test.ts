...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 5,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v5/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 9,
    },
    oldAuthority: {
      bindingVersion: 5,
      gitRemoteUrl: 'https://old.example.test/root/v5/projects/project-cloud/repository.git',
