...
function pendingRelocation() {
  return {
    ...
    newAuthority: {
      bindingVersion: 4,
      gitRemoteUrl: 'https://new.example.test/v4/projects/project-alpha/repository.git',
      serverUrl: 'https://new.example.test/',
      wireVersion: 8,
    },
    oldAuthority: {
      bindingVersion: 4,
      gitRemoteUrl: 'https://old.example.test/v4/projects/project-alpha/repository.git',
