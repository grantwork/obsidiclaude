...
function pendingRelocation() {
  return {
    ...
    newAuthority: {
      bindingVersion: 5,
      gitRemoteUrl: 'https://new.example.test/v5/projects/project-alpha/repository.git',
      serverUrl: 'https://new.example.test/',
      wireVersion: 9,
    },
    oldAuthority: {
      bindingVersion: 5,
      gitRemoteUrl: 'https://old.example.test/v5/projects/project-alpha/repository.git',
