...
describe('CollabFeaturePort', () => {
  it('keeps every feature operation behind the provider-neutral port', () => {
    const methodCoverage = {
      ...
      readPendingReconnect: true,
      resumeReconnect: true,
      resumeSetup: true,
      readSnapshot: true,
      readProjectCapabilities: true,
      ...
      listMembers: true,
      reissueMemberClaim: true,
      revokeMemberClaim: true,
      listManagerResponsibilityOffers: true,
      readManagementOperation: true,
      resumeManagementOperation: true,
      completeManagementOperation: true,
      ...
      proposeLanToCloudTransfer: true,
      readLanToCloudTransfer: true,
      readCloudToLanTransfer: true,
      acceptLanToCloudTransfer: true,
      cancelLanToCloudTransfer: true,
