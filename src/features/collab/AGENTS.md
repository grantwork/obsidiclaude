...
- An open request becomes the sole entry point for its personal conflict/recovered publication review. Explicit Update recovery belongs to the Project update entry regardless of an open request. Do not duplicate either action under My changes or replace My changes files with candidate-review files.
